...
`docs/KNOWN_GAPS.md`, `docs/SCHEMA_REFERENCE.md`, `DESIGN.md`, the status-sync skill
...
| 2026-09-14 — Webhook replay protection and a Redis-backed rate limiter | [`docs/addenda/2026-09.md`](addenda/2026-09.md) |
