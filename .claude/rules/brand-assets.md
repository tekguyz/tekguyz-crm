...
- **The mark has a reduced variant at small sizes, and that is not optional** — the nodes cannot resolve at favicon scale. Exact thresholds and which asset applies: `DESIGN.md` § Brand Identity → Two hard rules. Do not "simplify" this back to one asset.
